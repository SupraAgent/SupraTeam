...
export const BUILT_IN_TEMPLATES: FlowTemplate[] = [
  ...
  },
  {
    ...
    createdAt: "2026-03-30",
    nodes: [
      { id: "trigger", type: "triggerNode", position: { x: 0, y: 200 }, data: { label: "Broadcast Triggered", triggerType: "manual", config: "Select slug tag and message template" } },
      { id: "filter", type: "transformNode", position: { x: 300, y: 100 }, data: { label: "Filter by Slug", transformType: "filter", expression: "groups WHERE slug = $selected_slug" } },
      ...
      { id: "note", type: "noteNode", position: { x: 0, y: 400 }, data: { label: "Broadcasts", content: "Send personalized messages to all TG groups matching a slug. Uses merge variables for group-specific details." } },
    ],
    edges: [
